...
public class ObjectCasterToXML {

	public FacilityType castFacilityType(rs.ac.uns.ftn.agent.model.FacilityType tip) {
	...
	public Category castCategory(rs.ac.uns.ftn.agent.model.Category cat) {
	...
	public Destination castDestination(rs.ac.uns.ftn.agent.model.Destination des) {
	...
	public Location castLocation(rs.ac.uns.ftn.agent.model.Location loc) {
	...
	public FacilityAS castFacilityAS(rs.ac.uns.ftn.agent.model.FacilityAS fas) {
	...
	public UnitAS castUnitAS(rs.ac.uns.ftn.agent.model.UnitAS uas) {
	...
	public PricePerMonth castPricePerMonth(rs.ac.uns.ftn.agent.model.PricePerMonth ppm) {
	...
	public AccommodationFacility castAccommodationFacility(rs.ac.uns.ftn.agent.model.AccommodationFacility acc) {
		...
		System.out.println("ide ka res sa fas"+acc.getFacilityAS().size());
		for(rs.ac.uns.ftn.agent.model.FacilityAS f:acc.getFacilityAS()) {
		...
		System.out.println("dodalo fas"+accommodation.getFacilityAS().size());
		return accommodation;
	}
	
	public AccommodationUnit castAccommodationUnit(rs.ac.uns.ftn.agent.model.AccommodationUnit acc) {
		...
		for(rs.ac.uns.ftn.agent.model.UnitAS u:acc.getUnitAS()) {
	...
	public Reservation castReservation(rs.ac.uns.ftn.agent.model.Reservation res) {
